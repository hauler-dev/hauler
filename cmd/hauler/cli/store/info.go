...
// resolveCtype computes the human-readable content type ("image", "chart", "file", "directory", "sigs", "atts", "sbom", "referrer") for a descriptor from its config media type, defaulting to "image" when that's empty.
