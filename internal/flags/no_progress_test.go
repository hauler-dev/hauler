...
// TestAddChartOpts_NoProgressFlag proves --no-progress registered by
// AddChartOpts.AddFlags sets o.NoProgress, and defaults to false when unset.
func TestAddChartOpts_NoProgressFlag(t *testing.T) {
	tests := []struct {
		name string
		args []string
		want bool
