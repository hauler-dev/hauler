...
// storeIDPattern matches a StoreID or an unambiguous prefix of one,
// e.g. "ec520cf6" or "ec520cf6-e01b-4d6f-93ea-6588de0d5159"
var storeIDPattern = regexp.MustCompile(`^[0-9a-fA-F-]{8,36}$`)
...
func (o *StoreRootOpts) Store(ctx context.Context, ro *CliRootOpts) (*store.Layout, error) {
	...
	// If storeDir doesn't exist as a path, see if it's a StoreID (or an
	// unambiguous prefix of one) registered from a previous run elsewhere
